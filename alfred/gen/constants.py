...
DEBUG = True
EVAL = False
LACMA_ROOT = os.environ['LACMA_ROOT']
LACMA_DATA = os.environ['LACMA_DATA']
LACMA_LOGS = os.environ['LACMA_LOGS']
...
LOG_FILE = os.path.join(os.environ['LACMA_DATA'], 'logs_gen')
# paths to layouts
LAYOUTS_PATH = os.path.join(os.environ['LACMA_ROOT'], 'alfred/gen/layouts')
FF_PATH = os.path.join(os.environ['LACMA_ROOT'], 'alfred/gen/ff_planner/ff')
PLANNER_PATH = os.path.join(os.environ['LACMA_ROOT'], 'alfred/gen/planner')
